...
for data in assortment:
	if data['sub category']=="Mobile Accessories":
 		getBrand("http://saudi.souq.com/sa-en/mobile-accessories/mobile-phone-accessories-26/a-t/s/",data)
